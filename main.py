...
def configurar_pagina():
    ...
    st.set_page_config(page_title="Santy gpt" )

    st.title("Santy gpt")

    st.sidebar.title("elegi tu modelo")

    elegitumodelo = st.sidebar.selectbox("Elegí un modelo", options=MODELOS, index=0)

    return elegitumodelo
...
def main():
    ...
    promt_del_usuario = st.chat_input("Escribí tu pregunta: ")
